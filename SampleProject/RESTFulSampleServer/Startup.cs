...
using RESTFulSampleServer.Model.Context;
using RESTFulSampleServer.Business;
using RESTFulSampleServer.Business.Implementattions;
using RESTFulSampleServer.Repository.Generic;
using Tapioca.HATEOAS;
using RESTFulSampleServer.HyperMedia;
using Microsoft.Net.Http.Headers;
using Swashbuckle.AspNetCore.Swagger;
using Microsoft.AspNetCore.Rewrite;

namespace RESTFulSampleServer
{
